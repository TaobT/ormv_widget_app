...
class _CardsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          ...cards.map((cardData) => _CardType1(elevation: cardData['elevation'], label: cardData['label'])),
          ...cards.map((cardData) => _CardType2(elevation: cardData['elevation'], label: cardData['label'])),  
          ...cards.map((cardData) => _CardType3(elevation: cardData['elevation'], label: cardData['label'])),                  
          ...cards.map((cardData) => _CardType4(elevation: cardData['elevation'], label: cardData['label'])),          
